            ...
            <div class="row breadcrumbs-top d-inline-block">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"> <a href="#">Editar Questão</a>
                        </li>
                    </ol>
                </div>
            </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" id="basic-layout-form-center">Editar questão</h4>
                ...
                <div class="card-content collapse show">
                    ...
                    <div class="card-body">
                        <form class="form"
                            action="{{ route('question.update', ['question' => $question, 'quiz' => $quiz]) }}"
                            method="POST">
                            @csrf
                            @method('PUT')
