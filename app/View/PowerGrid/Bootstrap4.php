...
class Bootstrap4 extends ThemeBase
{
    ...
    {
        return Theme::table('table table-bordered table-hover table-striped mb-2')
            ->div('card')
            ->div('card-body')
            ...
            ->tdBodyTotalColumns('', 'font-size: 0.875rem; line-height: 1.25rem; color: rgb(76 79 82 / 1); padding-left: 0.75rem; padding-right: 0.75rem; padding-top: 0.5rem; padding-bottom: 0.5rem;')
    ...
    public function filterBoolean(): FilterBoolean
    {
        return Theme::filterBoolean()
            ...
            ->select('form-control shadow-none');
    }
